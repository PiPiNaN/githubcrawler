...
public class GithubCrawler {
    ...
    public void crawlUsers(String username) {
        try {
            GHUser user = github.getUser(username);
            
            for(GHUser u : user.getFollows()){
                System.out.println(u.getName()+" login name: "+ u.getLogin());
                
                System.out.println(u.getRepositories());
            }

            for (GHRepository r : user.listRepositories()) {
                System.out.println(r.getFullName());
                System.out.println(r.isFork());

//                for (GHUser u : r.getCollaborators()) {
//                    System.out.println("    " + u.getName());
//                }
            }

        } catch (IOException ex) {
            Logger.getLogger(GithubCrawler.class.getName()).log(Level.SEVERE, null, ex);
        }
